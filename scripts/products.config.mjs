...
export const products = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    subtitle:
      "ワンデーアキュビューオアシス「90枚入り×2箱セット(180枚)」を基準に、楽天市場・Yahoo!ショッピングの価格を毎日チェックし、それぞれのショップ別最安値トップ5を掲載しています。",
  ...
  // ------------------------------------------------------------------
  {
    ...
    subtitle:
      "ワンデーアキュビューオアシス乱視用「6箱(180枚)」を基準に、楽天市場・Yahoo!ショッピングの価格を毎日チェックし、それぞれのショップ別最安値トップ5を掲載しています。",
