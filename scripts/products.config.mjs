...
export const products = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    productIntroHtml: `    <h2 class="section-heading">90枚パック(マキシ)最安値を中心に比較しています</h2>
    <p>
    ...
    <p>
      メダリストワンデープラスは検索されている件数が非常に多い定番商品のため、
      取り扱うショップの数も多く、その分だけ価格競争が起きやすい傾向があります。
      これが、他の同価格帯の商品と比べても比較的安く手に入りやすい理由の
      一つと考えられます。だからこそ、ショップごとの価格差も生まれやすく、
      こまめな比較が効果を発揮しやすい商品とも言えます。
    </p>
    <p class="note">
      ※ 販売単位や内容量は、時期やショップにより変更・終了している場合があります。
      ご購入前に各販売店の商品ページで最新の内容量・価格をご確認ください。
  ...
  // ------------------------------------------------------------------
  // 10. 新しい商品を追加する場合は、ここに同じ形式でオブジェクトを追加する。
  // ------------------------------------------------------------------
];
