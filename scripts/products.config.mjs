...
export const products = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    subtitle:
      "「32枚×2箱」「96枚1箱」「96枚×2箱」それぞれの単位を基準に、楽天市場・Yahoo!ショッピングの価格を毎日チェックし、それぞれのショップ別最安値トップ5を掲載しています。",
    productSchemaName: "シードワンデーピュアうるおいプラス 32枚×2箱セット（64枚）",
    ...
    productIntroHtml: `    <h2 class="section-heading">32枚×2箱(64枚)あたりの価格を中心に比較しています</h2>
    <p>
      シードワンデーピュアうるおいプラスは、標準の32枚入りを何箱まとめて
      購入するかや、大容量の96枚入りパックを選ぶかによって、1枚あたりの
      単価が変わります。当サイトでは<strong>32枚×2箱セット(64枚)</strong>を
      基準に比較しつつ、96枚1箱・96枚×2箱で見つかった場合も、それぞれ
      別枠であわせて掲載しています。
    </p>
    <p class="note">
  ...
  // ------------------------------------------------------------------
  // 7. 新しい商品を追加する場合は、ここに同じ形式でオブジェクトを追加する。
  // ------------------------------------------------------------------
];
