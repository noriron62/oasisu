...
export const products = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    metaDescription:
      "ワンデーアキュビューオアシス乱視用の楽天市場・Yahoo!ショッピングの価格を毎日自動で比較し、1箱(30枚)あたりの最安値トップ5を掲載しています。",
    subtitle:
      "「1箱(30枚)」を基準に、楽天市場・Yahoo!ショッピングの価格を毎日チェックし、それぞれのショップ別最安値トップ5を掲載しています。",
    ...
    units: [
      ...
      },
      {
        ...
        introHtml: `    <h2 class="section-heading">2箱セットも見つかった場合はこちら</h2>
    <p>
      2箱セット(60枚・約2ヶ月分)で販売しているショップも一部あるため、
      見つかった場合はこちらに別枠で掲載しています。<strong>1箱の価格とは
    ...
    <p>
      ワンデーアキュビューオアシス乱視用は、通常版のような「90枚パック×2箱セット」
      ほど大きなまとめ売り単位は少なく、多くのショップで標準の
      <strong>30枚入り(1箱)</strong>単位で販売されています。
    </p>
    <p>
