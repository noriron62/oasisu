...
export const products = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    metaDescription:
      "ワンデーアキュビューオアシス乱視用の楽天市場・Yahoo!ショッピングの価格を毎日自動で比較し、6箱(180枚)あたりの最安値トップ5を掲載しています。",
    subtitle:
  ...
  // ------------------------------------------------------------------
  {
    ...
    subtitle:
      "ワンデーアキュビューモイスト「90枚入り×2箱セット(180枚)」を基準に、楽天市場・Yahoo!ショッピングの価格を毎日チェックし、それぞれのショップ別最安値トップ5を掲載しています。",
  ...
  // ------------------------------------------------------------------
  // 4. 新しい商品を追加する場合は、ここに同じ形式でオブジェクトを追加する。
  // ------------------------------------------------------------------
];
